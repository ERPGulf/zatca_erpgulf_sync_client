        ...
        // ✅ Check if the response starts with "Error"
                ...
                if (status === 'PASS') {
                    if (reportingStatus === 'CLEARED') {
                        ...
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf_sync_client/js/badges/zatca-cleared.png" alt="Cleared" class="zatca-badge" width="110" height="36" style="margin-top: -5px; margin-left: 215px;"></div>';

                    } else if (reportingStatus === 'REPORTED') {
                        console.log('PASS - Reported');
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf_sync_client/js/badges/zatca-reported.png" alt="Reported" class="zatca-badge" width="110" height="36" style="margin-top: -5px; margin-left: 215px;"></div>';
                    }
                }
                ...
                // 🟡 WARNING Conditions
                    ...
                    if (reportingStatus === 'CLEARED') {
                        ...
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf_sync_client/js/badges/zatca-cleared-warning.png" alt="Cleared with Warning" class="zatca-badge" width="110" height="36" style="margin-top: -5px; margin-left: 215px;"></div>';
                    } else if (reportingStatus === 'REPORTED') {
                        console.log('WARNING - Reported with Warning');
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf_sync_client/js/badges/zatca-reported-warning.png" alt="Reported with Warning" class="zatca-badge" width="110" height="36" style="margin-top: -5px; margin-left: 215px;"></div>';
                    }
                }
                ...
                // 🔴 FAILED Condition
                    ...
                    console.log('FAILED');
                    badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf_sync_client/js/badges/zatca-failed.png" alt="Failed" class="zatca-badge" width="110" height="36" style="margin-top: -5px; margin-left: 215px;"></div>';
                }
